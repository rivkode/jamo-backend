...
class ListMyFeedServiceTest {
    ...
    void happy_returns_my_diaries_with_single_user_summary() {
        ...
        FeedView feed = service.listMyFeed(new ListMyFeedQuery(author, Optional.empty(), 10));
    ...
    void hasNext_true_when_size_plus_one_returned() {
        ...
        FeedView feed = service.listMyFeed(new ListMyFeedQuery(author, Optional.empty(), 2));
