 ...
 * 문장 피드백의 입력 문장 VO.
 *
 * <p>박제: decisions/diary/sentence-feedback-domain-policy.md §9.
 *
 * <p><b>길이 invariant</b>: 1..50 <b>code points</b> ({@link String#codePointCount}).
 * char (UTF-16 code unit) 미사용 — 이모지 / 한자 surrogate pair 경계에서 글자 수 불일치 회피.
 *
...
public record SentenceText(String value) {
    ...
    public static final int MAX_CODE_POINTS = 50;
