 ...
 * <p>흐름:
 * <ol>
 *   <li>VO 생성 (DiaryContent / ImageUrls / Tags) — invariant 위반 시 도메인 예외 (400 매핑)</li>
...
public class CreateDiaryService {
    ...
    public DiaryView create(CreateDiaryCommand command) {
        DiaryContent content = new DiaryContent(command.content());
        ...
        Diary saved = transactionTemplate.execute(status -> {
            Diary diary = Diary.create(
                diaryId, command.authorId(), content, images, tags, command.visibility(), clock
            );
