...
/**
 * Frontend SPA 의 cross-origin 호출(예: {@code POST /api/v1/auth/exchange})을 허용하기 위한 CORS 정책.
 *
 * <p>인증 서비스이므로 {@code *} 대신 <b>명시 origin</b> 만 허용한다. dev/local 은
 * {@code http://localhost:3000}, prod 는 {@code https://jamoai.app} — env {@code CORS_ALLOWED_ORIGINS}
 * (쉼표 구분) 로 override.
 *
